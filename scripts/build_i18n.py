...
def _zh_pages() -> dict:
    return {
        ...
        "calendar_ai_subtitle": "输入主题或世界观，让 AI 一次性生成整套节日 / 纪念日，预览后可合并或替换到时间表",
        ...
        "calendar_ai_prompt_placeholder": "如：异世界/魔法/节日，或 现代都市/节日",
        "calendar_ai_prompt_hint": "描述世界观或场景，AI 会据此生成贴合主题的事项（Ctrl+Enter 快速生成）",
        "calendar_ai_generate_btn": "生成",
        "calendar_ai_generating": "生成中…",
        "calendar_ai_result_title": "预览（{count} 条）",
        "calendar_ai_preview_date": "{month}/{day}",
        "calendar_ai_apply_merge": "合并应用",
        "calendar_ai_apply_replace": "替换应用",
        "confirm_ai_apply_title": "应用 AI 时间表",
        "confirm_ai_apply_replace": "「替换应用」将清空现有全部事项并写入本次生成的事项，是否继续？",
...
def _en_pages() -> dict:
    return {
        ...
        "calendar_ai_subtitle": "Enter a theme or setting and let AI generate a full set of holidays / anniversaries at once; preview then merge or replace into the calendar",
        ...
        "calendar_ai_prompt_placeholder": "e.g. fantasy world/magic/holidays, or modern city/holidays",
        "calendar_ai_prompt_hint": "Describe the world or setting; AI generates matching events (Ctrl+Enter to generate)",
        "calendar_ai_generate_btn": "Generate",
        "calendar_ai_generating": "Generating…",
        "calendar_ai_result_title": "Preview ({count})",
        "calendar_ai_preview_date": "{month}/{day}",
        "calendar_ai_apply_merge": "Merge",
        "calendar_ai_apply_replace": "Replace",
        "confirm_ai_apply_title": "Apply AI calendar",
        "confirm_ai_apply_replace": '"Replace" will clear all existing events and write the generated ones. Continue?',
