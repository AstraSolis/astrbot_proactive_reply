...
def _zh_pages() -> dict:
    return {
        ...
        "calendar_disabled_desc": "打开上方开关即可编辑日历事项",
...
def _en_pages() -> dict:
    return {
        ...
        "calendar_disabled_desc": "Turn on the switch above to edit calendar events",
...
def _zh_api() -> dict:
    return {
        ...
        "messages": {
            ...
            "calendar_enabled_updated": "时间表开关已更新",
            "calendar_settings_updated": "时间表显示设置已更新",
        },
        "activity": {
...
def _en_api() -> dict:
    return {
        ...
        "messages": {
            ...
            "calendar_enabled_updated": "Calendar toggle updated",
            "calendar_settings_updated": "Calendar display settings updated",
        },
        "activity": {
