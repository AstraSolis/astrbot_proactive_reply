...
def _zh_pages() -> dict:
    return {
        ...
        "tag_proactive": "主动消息",
        "tag_ai_schedule": "AI 调度",
        "tag_timer": "定时任务",
        "empty_activity_title": "暂无活动记录",
        "empty_activity_desc": "当插件开始工作后，活动记录将在此显示",
        "empty_sessions_title": "还没有主动会话",
        "empty_sessions_desc": "通过右上角按钮添加，或在聊天中使用",
        "load_sessions_failed": "加载失败，请切换 Tab 后重试",
        "th_session_id": "会话 ID",
        "th_platform": "平台",
        "th_user": "用户",
        "th_next_send": "下次发送",
...
def _en_pages() -> dict:
    return {
        "title": "Proactive Mind Console",
        "description": "Dashboard and session management",
        ...
        "session_list": "Proactive sessions",
        ...
        "stat_ai_schedules": "AI schedules",
        ...
        "empty_sessions_desc": "Use the button above or run",
        "load_sessions_failed": "Load failed — switch tabs and try again",
        ...
        "err_dashboard_load": "Failed to load dashboard:",
