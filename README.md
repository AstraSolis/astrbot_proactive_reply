...
- **AI 生成时间表**：在「时间表」页签输入主题或世界观（如「异世界/魔法/节日」「现代都市/节日」），由 AI 一次性生成整套贴合主题的节日 / 纪念日，预览后可「合并应用」或「替换应用」到时间表；可在配置中指定生成所用的模型与系统提示词
...
- **AI 生成时间表的系统提示词**：自定义生成时间表的系统提示词
  ...
  - 使用方式：在「时间表」页签输入主题（如「异世界/魔法/节日」），点击「生成」预览，再选择「合并应用」或「替换应用」
